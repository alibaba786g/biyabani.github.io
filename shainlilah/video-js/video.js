...
(function(window, undefined) {
    ...
    VideoJS.options = {
        ...
        html5: {},
        flash: {swf: (window["flash_player_path"] ? window["flash_player_path"] + "Player.swf" : "Player.swf")},
        ...
        // defaultVolume: 0.85,
        defaultVolume: 0.00,
        // The freakin seaguls are driving me crazy!
        // Included control sets
        components: ["poster", "loadingSpinner", "bigPlayButton",
        {
            name: "controlBar",
            options: {
                components: ["playToggle", "fullscreenToggle", "currentTimeDisplay", "timeDivider", "durationDisplay", "remainingTimeDisplay",
                {
                    ...
                    options: {
                        components: [{
                            name: "seekBar",
                            options: {
                                components: ["loadProgressBar", "playProgressBar", "seekHandle"]
                            }
                        }]
                    }
                }, {
                    ...
                    options: {
                        components: [{
                            name: "volumeBar",
                            options: {
                                components: ["volumeLevel", "volumeHandle"]
                            }
                        }]
                    }
                }, "muteToggle"]
  ...
  ================================================================================ */
        ...
        // Unique attribute to store element's guid in
    ...
    _V_.Player = _V_.Component.extend({
        ...
        init: function(tag, addOptions, ready) {
            ...
            var el = this.el = _V_.createElement("div"),
                // Div to contain video and controls
...
================================================================================ */
        ...
        supportsFullScreen: function() {
            return this.apiCall("supportsFullScreen");
        },
        ...
        poster: function() {
            return this.apiCall("poster");
        },

        error: function() {
            return this.apiCall("error");
        },
        networkState: function() {
            return this.apiCall("networkState");
        },
        readyState: function() {
            return this.apiCall("readyState");
        },
        seeking: function() {
            return this.apiCall("seeking");
        },
        initialTime: function() {
            return this.apiCall("initialTime");
        },
        startOffsetTime: function() {
            return this.apiCall("startOffsetTime");
        },
        played: function() {
            return this.apiCall("played");
        },
        seekable: function() {
            return this.apiCall("seekable");
        },
        ended: function() {
            return this.apiCall("ended");
        },
        videoTracks: function() {
            return this.apiCall("videoTracks");
        },
        audioTracks: function() {
            return this.apiCall("audioTracks");
        },
        videoWidth: function() {
            return this.apiCall("videoWidth");
        },
        videoHeight: function() {
            return this.apiCall("videoHeight");
        },
        defaultPlaybackRate: function() {
            return this.apiCall("defaultPlaybackRate");
        },
        playbackRate: function() {
            return this.apiCall("playbackRate");
        },
        // mediaGroup: function(){ return this.apiCall("mediaGroup"); },
        // controller: function(){ return this.apiCall("controller"); },
        controls: function() {
            return this.apiCall("controls");
        },
        defaultMuted: function() {
            return this.apiCall("defaultMuted");
        }
    });

    // RequestFullscreen API
    (function() {
        var requestFn, cancelFn, playerProto = _V_.Player.prototype;
...
================================================================================ */
    _V_.html5 = _V_.PlaybackTech.extend({
        ...
        initialTime: function() {
            return this.el.initialTime;
        },
        startOffsetTime: function() {
            return this.el.startOffsetTime;
        },
        played: function() {
        ...
        mediaGroup: function() {
            return this.el.mediaGroup;
        },
        controller: function() {
            return this.el.controller;
        },
        controls: function() {
...
================================================================================ */
    _V_.flash = _V_.PlaybackTech.extend({
        ...
        init: function(player, options) {
            ...
            var source = options.source,
            	...
            	var swfpath = this.player.options["flash_player_path"] ? this.player.options["flash_player_path"] + "Player.swf" : options.swf;
            	swf = swfpath;
							swf += "?&path=";
            	swf += (this.player.options["media_path"] ? this.player.options["media_path"] : source.src);
            ...
            //swfobject.embedSWF(options.swf, placeHolder.id, options.parentEl.player.options.width, options.parentEl.player.options.height, "9.0.124", "", flashVars, params, attributes);
            swfobject.embedSWF(swfpath, placeHolder.id, options.parentEl.player.options.width, options.parentEl.player.options.height, "9.0.124", "", flashVars, params, attributes);
        },
    ...
    _V_.Track = function(attributes, player) {
        ...
        player.addEvent("ended", _V_.proxy(this, function() {
            this.lastCueIndex = 0;
        }));
                ...
                if (!this.currentCue || this.currentCue.startTime >= time || this.currentCue.endTime < time) {
                    ...
                    while (true) { // Loop until broken
                        if (reverse) { // Looping in reverse
                            ...
                            if (i < 0 || this.cues[i].endTime < time) {
                                break;
                            }
                            ...
                            if (i >= this.cues.length || this.cues[i].startTime > time) {
                                break;
                            }
